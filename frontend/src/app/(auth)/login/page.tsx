...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden">
      ...
      <div className="absolute top-20 -left-32 w-80 h-80 bg-blue-300/20 rounded-full blur-3xl animate-blob" />
      <div className="absolute bottom-20 -right-32 w-80 h-80 bg-purple-300/20 rounded-full blur-3xl animate-blob" style={{ animationDelay: "3s" }} />
        ...
        >
          ...
          <div className="glass rounded-2xl p-8 shadow-xl border border-white/30">
            ...
            <div className="space-y-2">
              ...
              <button
                onClick={handleGuest}
                className="w-full border py-2.5 rounded-xl font-medium hover:bg-gray-50 transition-colors text-sm text-muted-foreground"
                disabled={loading}
              >
                Continue as Guest
              </button>
