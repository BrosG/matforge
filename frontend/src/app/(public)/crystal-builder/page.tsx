...
const CrystalBuilder = dynamic(
  () => import("@/components/crystal-builder/CrystalBuilder"),
  {
    ssr: false,
    loading: () => (
      <div className="h-screen w-full flex items-center justify-center bg-gray-50 dark:bg-gray-950">
        <div className="text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Loading Crystal Structure Builder...
          </p>
        </div>
      </div>
    ),
...
export default function CrystalBuilderPage() {
  return (
    <Suspense
      fallback={
