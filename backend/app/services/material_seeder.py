...
MATERIAL_TEMPLATES = [
    ...
    (
        ...
        1.0,
        [
            {"el": "Si", "x": 0.0, "y": 0.0, "z": 0.0},
            {"el": "Si", "x": 0.25, "y": 0.25, "z": 0.25},
        ],
    ),
    (
        "Ge",
        ...
        1.0,
        [
            {"el": "Ge", "x": 0.0, "y": 0.0, "z": 0.0},
            {"el": "Ge", "x": 0.25, "y": 0.25, "z": 0.25},
        ],
    ),
    (
        "Fe",
    ...
    (
        ...
        0.644,
        [
            {"el": "Ti", "x": 0.0, "y": 0.0, "z": 0.0},
            {"el": "O", "x": 0.305, "y": 0.305, "z": 0.0},
        ],
    ),
    (
        "Al2O3",
        ...
        2.73,
        [
            {"el": "Al", "x": 0.0, "y": 0.0, "z": 0.352},
            {"el": "O", "x": 0.306, "y": 0.0, "z": 0.25},
        ],
    ),
    (
        "ZnO",
        ...
        1.60,
        [
            {"el": "Zn", "x": 0.333, "y": 0.667, "z": 0.0},
            {"el": "O", "x": 0.333, "y": 0.667, "z": 0.382},
        ],
    ),
    (
        "SiO2",
        ...
        1.10,
        [
            {"el": "Si", "x": 0.470, "y": 0.0, "z": 0.333},
            {"el": "O", "x": 0.414, "y": 0.268, "z": 0.286},
        ],
    ),
    (
        "Fe2O3",
    ...
    (
        ...
        1.0,
        [
            {"el": "Mg", "x": 0.0, "y": 0.0, "z": 0.0},
            {"el": "O", "x": 0.5, "y": 0.5, "z": 0.5},
        ],
    ),
    (
        "CeO2",
        ...
        1.0,
        [
            {"el": "Ce", "x": 0.0, "y": 0.0, "z": 0.0},
            {"el": "O", "x": 0.25, "y": 0.25, "z": 0.25},
        ],
    ),
    (
        "SnO2",
        ...
        0.672,
        [
            {"el": "Sn", "x": 0.0, "y": 0.0, "z": 0.0},
            {"el": "O", "x": 0.307, "y": 0.307, "z": 0.0},
        ],
    ),
    ...
    (
        ...
        1.0,
        [
            {"el": "Ga", "x": 0.0, "y": 0.0, "z": 0.0},
            {"el": "As", "x": 0.25, "y": 0.25, "z": 0.25},
        ],
    ),
    (
        "GaN",
        ...
        1.63,
        [
            {"el": "Ga", "x": 0.333, "y": 0.667, "z": 0.0},
            {"el": "N", "x": 0.333, "y": 0.667, "z": 0.377},
        ],
    ),
    (
        "InP",
        ...
        1.0,
        [
            {"el": "In", "x": 0.0, "y": 0.0, "z": 0.0},
            {"el": "P", "x": 0.25, "y": 0.25, "z": 0.25},
        ],
    ),
    (
        "ZnS",
        ...
        1.0,
        [
            {"el": "Zn", "x": 0.0, "y": 0.0, "z": 0.0},
            {"el": "S", "x": 0.25, "y": 0.25, "z": 0.25},
        ],
    ),
    (
        "CdTe",
        ...
        1.0,
        [
            {"el": "Cd", "x": 0.0, "y": 0.0, "z": 0.0},
            {"el": "Te", "x": 0.25, "y": 0.25, "z": 0.25},
        ],
    ),
    (
        "SiC",
    ...
    (
        ...
        2.66,
        [
            {"el": "B", "x": 0.0, "y": 0.0, "z": 0.0},
            {"el": "N", "x": 0.333, "y": 0.667, "z": 0.0},
        ],
    ),
    (
        "AlN",
        ...
        1.60,
        [
            {"el": "Al", "x": 0.333, "y": 0.667, "z": 0.0},
            {"el": "N", "x": 0.333, "y": 0.667, "z": 0.382},
        ],
    ),
    ...
    (
        ...
        1.01,
        [
            {"el": "Ba", "x": 0.0, "y": 0.0, "z": 0.0},
            {"el": "Ti", "x": 0.5, "y": 0.5, "z": 0.5},
    ...
    (
        ...
        1.42,
        [
            {"el": "Ca", "x": 0.0, "y": 0.25, "z": 0.005},
            {"el": "Ti", "x": 0.0, "y": 0.0, "z": 0.5},
    ...
    (
        ...
        4.99,
        [
            {"el": "Li", "x": 0.0, "y": 0.0, "z": 0.5},
            {"el": "Co", "x": 0.0, "y": 0.0, "z": 0.0},
    ...
    (
        "LiFePO4",
        ["Li", "Fe", "P", "O"],
        {"Li": 0.143, "Fe": 0.143, "P": 0.143, "O": 0.571},
        "orthorhombic",
        3.84,
        -3.18,
        3.60,
        ...
        0.46,
        [
            {"el": "Li", "x": 0.0, "y": 0.0, "z": 0.0},
            {"el": "Fe", "x": 0.282, "y": 0.25, "z": 0.975},
            {"el": "P", "x": 0.095, "y": 0.25, "z": 0.418},
            {"el": "O", "x": 0.097, "y": 0.25, "z": 0.743},
        ],
    ),
    (
        "LiMn2O4",
        ["Li", "Mn", "O"],
        {"Li": 0.143, "Mn": 0.286, "O": 0.571},
        "cubic",
        1.80,
        -2.78,
        4.28,
        ...
        1.0,
        [
            {"el": "Li", "x": 0.125, "y": 0.125, "z": 0.125},
            {"el": "Mn", "x": 0.5, "y": 0.5, "z": 0.5},
    ...
    (
        ...
        1.23,
        [
            {"el": "Na", "x": 0.0, "y": 0.0, "z": 0.5},
            {"el": "Mn", "x": 0.0, "y": 0.0, "z": 0.0},
    ...
    (
        ...
        3.89,
        [
            {"el": "Mo", "x": 0.333, "y": 0.667, "z": 0.25},
            {"el": "S", "x": 0.333, "y": 0.667, "z": 0.621},
        ],
    ),
    (
        "WS2",
        ...
        3.92,
        [
            {"el": "W", "x": 0.333, "y": 0.667, "z": 0.25},
            {"el": "S", "x": 0.333, "y": 0.667, "z": 0.625},
        ],
    ),
    (
        "Bi2Te3",
        ...
        6.95,
        [
            {"el": "Bi", "x": 0.0, "y": 0.0, "z": 0.400},
            {"el": "Te", "x": 0.0, "y": 0.0, "z": 0.0},
        ],
    ),
    (
        "PbTe",
        ...
        1.0,
        [
            {"el": "Pb", "x": 0.0, "y": 0.0, "z": 0.0},
            {"el": "Te", "x": 0.5, "y": 0.5, "z": 0.5},
        ],
    ),
    # --- Spinels / garnets ---
    (
        ...
        1.0,
        [
            {"el": "Mg", "x": 0.125, "y": 0.125, "z": 0.125},
            {"el": "Al", "x": 0.5, "y": 0.5, "z": 0.5},
            {"el": "O", "x": 0.263, "y": 0.263, "z": 0.263},
        ],
    ),
    (
    ...
    (
        ...
        1.0,
        [
            {"el": "Na", "x": 0.0, "y": 0.0, "z": 0.0},
            {"el": "Cl", "x": 0.5, "y": 0.5, "z": 0.5},
        ],
    ),
    (
        "CaF2",
        ...
        1.0,
        [
            {"el": "Ca", "x": 0.0, "y": 0.0, "z": 0.0},
            {"el": "F", "x": 0.25, "y": 0.25, "z": 0.25},
        ],
    ),
    (
        "CsPbI3",
        ...
        1.44,
        [
            {"el": "Cs", "x": 0.0, "y": 0.25, "z": 0.0},
            {"el": "Pb", "x": 0.5, "y": 0.0, "z": 0.0},
    ...
    (
        ...
        0.82,
        [
            {"el": "Ba", "x": 0.184, "y": 0.25, "z": 0.158},
            {"el": "S", "x": 0.437, "y": 0.25, "z": 0.190},
    ...
    (
        ...
        1.03,
        [
            {"el": "Zr", "x": 0.276, "y": 0.040, "z": 0.208},
            {"el": "O", "x": 0.070, "y": 0.332, "z": 0.345},
        ],
    ),
    (
        "HfO2",
    ...
    (
        ...
        0.38,
        [
            {"el": "V", "x": 0.149, "y": 0.0, "z": 0.109},
            {"el": "O", "x": 0.149, "y": 0.0, "z": 0.469},
        ],
    ),
    (
        "Nb2O5",
        ...
        0.30,
        [
            {"el": "Nb", "x": 0.0, "y": 0.0, "z": 0.0},
            {"el": "O", "x": 0.1, "y": 0.1, "z": 0.1},
        ],
    ),
    (
        "CoO",
    ...
    (
        ...
        1.09,
        [
            {"el": "Cu", "x": 0.25, "y": 0.25, "z": 0.0},
            {"el": "O", "x": 0.0, "y": 0.418, "z": 0.25},
        ],
    ),
]
...
def seed_materials(db: Session, count: int = 1000) -> int:
    ...
    for i in range(count):
        ...
        is_theoretical = True
        calculation_method = rng.choice(
            ["GGA-PBE", "GGA-PBE", "GGA-PBE", "HSE06", "GGA+U"]
        )
        ...
        if crystal_system == "triclinic":
            warnings_list.append(
                "Low-symmetry structure — DFT approximation may be less reliable"
            )
        ...
        record = IndexedMaterial(
            ...
            # Thermal
            thermal_conductivity=round(thermal_conductivity, 2)
            if thermal_conductivity
            else None,
            seebeck_coefficient=round(seebeck_coefficient, 1)
            if seebeck_coefficient
            else None,
            # Carrier
